...
start \\metaro-server\UsuariosAD\%USERNAME%\Desktop\ImprimePDF\resource\bin\node-v21.6.1-x64.msi
echo.
exit
goto fim
:NAO
...
:SIM
echo O usuario pressionou [S]
start \\metaro-server\UsuariosAD\%USERNAME%\Desktop\ImprimePDF\resource\bin\AdbeRdr920_pt_BR.exe
echo.
goto fim
:NAO
echo O usuario pressionou [N]
